...
#let _color(t) = {
  if t == "dir" { rgb("#d79b00") }
  else if t == "key" { rgb("#b85450") }
  else if t == "tree" { rgb("#82b366") }
  else { rgb("#6c8ebf") }
}
...
#let _flujo(
  ...
  [#text(size: 11pt, weight: "bold")[#titulo-entradas] #v(0.3em) #_arbol(entradas)],
  // Caja proceso
  _proceso(titulo-caja),
  // Cabecera + árbol salida
  [#text(size: 11pt, weight: "bold")[#titulo-salida] #v(0.3em) #_arbol(salida)],
)
