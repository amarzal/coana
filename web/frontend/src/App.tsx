...
import { InvestigacionGrupos, InvestigacionHorasKalendas } from "@/routes/investigacion";
import {
    ResultadosResumen,
    ResultadosTodasUc,
    ResultadosAnomalias,
            ...
            <BrowserRouter>
                <Routes>
                    ...
                    <Route path="personal/costes-sociales-calculados" element={<PersonalCostesSocialesCalculados />} />
                        ...
                        <Route path="investigacion/horas-kalendas" element={<InvestigacionHorasKalendas />} />
                        ...
                        <Route path="reparto/dag" element={<RepartoDag />} />
